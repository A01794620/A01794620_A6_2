...
class HotelTest(unittest.TestCase):
    ...
    def test_assert_true_uuid_value(self):
        ...
        self.assertTrue(self.hotel.is_valid_id(), msg="Testing if UUID is Valid")
    ...
    def test_assert_true_name_value(self):
        ...
        self.assertTrue(self.hotel.is_valid_name(), msg="Testing if Hotel Name is Valid")


    def test_assert_false_name_value(self):
        self.hotel.name = Setting.NULL_VALUE
        self.assertFalse(self.hotel.is_valid_name(), msg="Testing if Hotel Name is not Valid")
    ...
    def test_assert_true_address_value(self):
        ...
        self.assertTrue(self.hotel.is_valid_address(), msg="Testing if Hotel's Address is Valid")

    def test_assert_false_address_value(self):
        self.hotel.address = Setting.NULL_VALUE
        self.assertFalse(self.hotel.is_valid_address(), msg="Testing if Hotel's Address is not Valid")
    ...
    def test_assert_true_valid_email_id(self):
        ...
        self.assertTrue(self.hotel.is_valid_email(), msg="Testing if E-mail ID is valid")

    def test_assert_false_valid_email_id(self):
        self.hotel.email = Setting.NULL_VALUE
        self.assertFalse(self.hotel.is_valid_email(), msg="Testing if E-mail ID is not valid")
    ...
    def test_assert_true_valid_phone_number(self):
        ...
        self.assertTrue(self.hotel.is_valid_phone(), msg="Testing if phone number is valid")

    def test_assert_false_valid_phone_number(self):
        self.hotel.phone = Setting.NULL_VALUE
        self.assertFalse(self.hotel.is_valid_phone(), msg="Testing if phone number is not valid")
