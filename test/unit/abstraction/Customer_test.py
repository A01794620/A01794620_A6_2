...
class CustomerTest(unittest.TestCase):
    ...
    def test_assert_true_uuid_value(self):
        ...
        self.assertTrue(self.customer.is_valid_id(), msg="Testing if UUID is Valid")
    ...
    def test_assert_true_fullname_value(self):
        ...
        self.assertTrue(self.customer.is_valid_fullname(), msg="Testing if Fullname is Valid")

    def test_assert_false_fullname_value(self):
        self.customer.fullname = Setting.NULL_VALUE
        self.assertFalse(self.customer.is_valid_fullname(), msg="Testing if Fullname is not Valid")
