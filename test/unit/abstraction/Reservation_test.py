...
class ReservationTest(unittest.TestCase):
    ...
    def test_assert_true_uuid_value(self):
        ...
        self.assertTrue(self.reservation.is_valid_id(), msg="Testing if UUID is Valid")

    def test_assert_false_uuid_value(self):
        self.reservation.id = Setting.NULL_VALUE
        self.assertFalse(self.reservation.is_valid_id(), msg="Testing if UUID is not Valid")
    # Hotel ID
    ...
    def test_assert_true_hotel_uuid_value(self):
        ...
        self.assertTrue(self.reservation.is_valid_hotel_id(), msg="Testing if Hotel UUID is Valid")

    def test_assert_false_hotel_uuid_value(self):
        self.reservation.hotel_id = Setting.NULL_VALUE
        self.assertFalse(self.reservation.is_valid_hotel_id(), msg="Testing if Hotel UUID is not Valid")
    ...
    def test_assert_true_customer_uuid_value(self):
        ...
        self.assertTrue(self.reservation.is_valid_customer_id(), msg="Testing if Customer UUID is Valid")

    def test_assert_false_customer_uuid_value(self):
        self.reservation.customer_id = Setting.NULL_VALUE
        self.assertFalse(self.reservation.is_valid_customer_id(), msg="Testing if Customer UUID is not Valid")
